...
class TestHardcodedPromptsFallback:
    ...
    def test_nlu_topic_extraction_hardcoded_exists(self):
        ...
        with SessionLocal() as session:
            ...
            assert row is not None, "NLU topic extraction prompt should exist in database"
    ...
    def test_clarification_question_hardcoded_exists(self):
        ...
        with SessionLocal() as session:
            ...
            assert row is not None, "Clarification question prompt should exist in database"
    ...
    def test_prompts_have_valid_json_variables(self):
        ...
        with SessionLocal() as session:
            ...
            for prompt in prompts:
                ...
                assert variables is not None, f"Prompt '{name}' should have variables field"

                # Should be parseable as JSON
                try:
                    var_list = json.loads(variables) if isinstance(variables, str) else variables
                    assert isinstance(var_list, list), f"Prompt '{name}' variables should be a list"
...
class TestGuardrailBackwardsCompatibility:
    ...
    def test_guardrails_are_enforced_but_not_blocking(self):
        ...
        with SessionLocal() as session:
            ...
            assert blocking_count == 0, "No guardrails should be in blocking mode initially"
    ...
    def test_guardrails_have_warning_level(self):
        ...
        with SessionLocal() as session:
            ...
            for guardrail in guardrails:
                ...
                assert enforcement_level in ['warning', 'blocking'], \
...
class TestPromptVersioning:
    ...
    def test_only_one_active_version_per_prompt(self):
        ...
        with SessionLocal() as session:
            ...
            assert len(duplicates) == 0, "Each prompt should have only one active version"
    ...
    def test_can_retrieve_and_use_nlu_prompt(self):
        ...
        with SessionLocal() as session:
            ...
            for var in var_list:
                ...
                assert f"{{{var}}}" in content or var in content.lower(), \

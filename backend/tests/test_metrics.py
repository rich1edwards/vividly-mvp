...
class TestMetricsClientInitialization:
    ...
    @patch('app.core.metrics.monitoring_v3.MetricServiceClient', side_effect=Exception("GCP API error"))
...
class TestMetricsClientWriteTimeSeries:
    ...
    @patch('app.core.metrics.monitoring_v3.MetricServiceClient')
    @patch.dict(os.environ, {'METRICS_ENABLED': 'true'})
    def test_write_time_series_handles_gcp_api_errors_gracefully(self, mock_client_class):
...
class TestRateLimitingMetrics:
    ...
    def test_increment_rate_limit_hits(self, mock_client_class):
        ...
        client = MetricsClient(project_id='test-project')
        client.increment_rate_limit_hits(endpoint='/api/auth/login', ip_address='127.0.0.1')

        call_args = mock_client_instance.create_time_series.call_args
        time_series = call_args[1]['time_series'][0]

        assert time_series.metric.type == 'custom.googleapis.com/vividly/rate_limit_hits_total'
    ...
    def test_increment_rate_limit_exceeded(self, mock_client_class):
        ...
        client = MetricsClient(project_id='test-project')
        client.increment_rate_limit_exceeded(endpoint='/api/content', ip_address='192.168.1.1')

        call_args = mock_client_instance.create_time_series.call_args
        time_series = call_args[1]['time_series'][0]

        assert time_series.metric.type == 'custom.googleapis.com/vividly/rate_limit_exceeded_total'
    ...
    def test_increment_brute_force_lockouts_with_email(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/brute_force_lockouts_total'
    ...
    def test_record_rate_limit_middleware_latency(self, mock_client_class):
        ...
        client = MetricsClient(project_id='test-project')
        client.record_rate_limit_middleware_latency(endpoint='/api/health', latency_ms=12.5)

        call_args = mock_client_instance.create_time_series.call_args
        time_series = call_args[1]['time_series'][0]

        assert time_series.metric.type == 'custom.googleapis.com/vividly/rate_limit_middleware_latency_ms'
...
class TestAuthenticationMetrics:
    ...
    def test_increment_auth_login_attempts_success(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/auth_login_attempts_total'
    ...
    def test_increment_auth_login_failures(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/auth_login_failures_total'
    ...
    def test_increment_auth_token_refresh(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/auth_token_refresh_total'
        assert time_series.metric.labels['status'] == 'success'
    ...
    def test_record_auth_session_duration(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/auth_session_duration_seconds'
    ...
    def test_set_auth_active_sessions(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/auth_active_sessions'
...
class TestSystemHealthMetrics:
    ...
    def test_increment_http_request(self, mock_client_class):
        ...
        client = MetricsClient(project_id='test-project')
        client.increment_http_request(method='GET', endpoint='/api/health', status_code=200)

        call_args = mock_client_instance.create_time_series.call_args
        time_series = call_args[1]['time_series'][0]

        assert time_series.metric.type == 'custom.googleapis.com/vividly/http_request_total'
    ...
    def test_increment_http_request_error_status(self, mock_client_class):
        ...
        client = MetricsClient(project_id='test-project')
        client.increment_http_request(method='POST', endpoint='/api/content', status_code=500)
    ...
    def test_record_request_duration(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/http_request_duration_seconds'
...
class TestContentGenerationMetrics:
    ...
    def test_increment_content_generation_requests_pending(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/content_generation_requests_total'
    ...
    def test_record_content_generation_duration_nlu_stage(self, mock_client_class):
        ...
        assert time_series.metric.type == 'custom.googleapis.com/vividly/content_generation_duration_seconds'
...
class TestConvenienceFunctions:
    ...
    def test_record_request_duration_convenience(self, mock_client_class):
        ...
        record_request_duration(method='POST', endpoint='/api/test', duration_seconds=0.5)

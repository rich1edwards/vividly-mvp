...
# Database connection
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://vividly:password@localhost:5432/vividly_dev")
...
def seed_users(session, org_ids):
    ...
    hillsboro_students = [
        ("John", "Doe", 11), ("Jane", "Smith", 11), ("Mike", "Johnson", 11),
        ("Sarah", "Lee", 10), ("Tom", "Wilson", 10), ("Emma", "Davis", 10),
        ("Chris", "Brown", 12), ("Amy", "Miller", 12), ("Ryan", "Garcia", 12),
        ("Kelly", "Martinez", 9), ("Alex", "Rodriguez", 9), ("Sam", "Hernandez", 9),
        ("Jordan", "Lopez", 11), ("Taylor", "Gonzalez", 11), ("Casey", "Perez", 11),
        ("Morgan", "Turner", 10), ("Riley", "Phillips", 10), ("Avery", "Campbell", 10),
        ("Quinn", "Parker", 12), ("Dakota", "Evans", 12)
    ]
    ...
    early_students = [
        ("Daniel", "White", 11), ("Sophia", "Harris", 11), ("Ethan", "Martin", 11),
        ("Olivia", "Thompson", 10), ("Mason", "Jackson", 10), ("Isabella", "Robinson", 10),
        ("Lucas", "Clark", 12), ("Mia", "Lewis", 12), ("Noah", "Walker", 12),
        ("Ava", "Hall", 9), ("Liam", "Allen", 9), ("Emma", "Young", 9),
        ("Oliver", "King", 11), ("Amelia", "Wright", 11), ("Elijah", "Scott", 11)
    ]
    ...
    session.commit()
    print(f"✓ Created {len(user_data)} users (3 admins, 7 teachers, {len(student_ids)} students)")
...
def seed_subjects_and_topics(session):
    ...
    sample_topics = [
        # Physics
        {"id": "topic_phys_mech_newton_3", "name": "Newton's Third Law", "subject": "physics",
         "category": "Mechanics", "subcategory": "Forces", "description": "For every action, there is an equal and opposite reaction"},
        {"id": "topic_phys_mech_kinematics", "name": "Kinematics", "subject": "physics",
         "category": "Mechanics", "subcategory": "Motion", "description": "Study of motion without considering forces"},
        {"id": "topic_phys_energy_conservation", "name": "Conservation of Energy", "subject": "physics",
         "category": "Energy", "subcategory": "Energy", "description": "Energy cannot be created or destroyed"},

        # Chemistry
        {"id": "topic_chem_bonding_ionic", "name": "Ionic Bonding", "subject": "chemistry",
         "category": "Chemical Bonding", "subcategory": "Bonding", "description": "Transfer of electrons between atoms"},
        {"id": "topic_chem_reactions_synthesis", "name": "Synthesis Reactions", "subject": "chemistry",
         "category": "Chemical Reactions", "subcategory": "Reactions", "description": "Two or more reactants combine to form a product"},
        {"id": "topic_chem_acid_base", "name": "Acids and Bases", "subject": "chemistry",
         "category": "Acids and Bases", "subcategory": "pH", "description": "Properties and reactions of acids and bases"},

        # Biology
        {"id": "topic_bio_cell_photosynthesis", "name": "Photosynthesis", "subject": "biology",
         "category": "Cell Processes", "subcategory": "Energy", "description": "Process by which plants convert light energy into chemical energy"},
        {"id": "topic_bio_genetics_mendel", "name": "Mendelian Genetics", "subject": "biology",
         "category": "Genetics", "subcategory": "Inheritance", "description": "Basic principles of genetic inheritance"},
        {"id": "topic_bio_evolution_selection", "name": "Natural Selection", "subject": "biology",
         "category": "Evolution", "subcategory": "Selection", "description": "Mechanism of evolution by differential survival"},

        # Computer Science
        {"id": "topic_cs_algo_binary_search", "name": "Binary Search", "subject": "computer_science",
         "category": "Algorithms", "subcategory": "Searching", "description": "Efficient algorithm for searching sorted arrays"},
        {"id": "topic_cs_data_arrays", "name": "Arrays", "subject": "computer_science",
         "category": "Data Structures", "subcategory": "Arrays", "description": "Contiguous memory storage for elements"},
        {"id": "topic_cs_oop_classes", "name": "Classes and Objects", "subject": "computer_science",
         "category": "Object-Oriented Programming", "subcategory": "OOP", "description": "Blueprint for creating objects"},
    ]
...
def seed_classes(session, org_ids, teacher_ids):
    ...
    classes = [
        # Hillsboro High
        {"teacher": "hillsboro_1", "name": "Physics 101 - Period 3", "subject": "physics", "grade": 11, "org": "hillsboro"},
        {"teacher": "hillsboro_2", "name": "Chemistry 101 - Period 2", "subject": "chemistry", "grade": 11, "org": "hillsboro"},
        {"teacher": "hillsboro_3", "name": "Biology 101 - Period 4", "subject": "biology", "grade": 10, "org": "hillsboro"},
        {"teacher": "hillsboro_4", "name": "Computer Science 101 - Period 1", "subject": "computer_science", "grade": 11, "org": "hillsboro"},

        # Early College High
        {"teacher": "early_1", "name": "Physics Honors - Block A", "subject": "physics", "grade": 12, "org": "early_college"},
        {"teacher": "early_2", "name": "Chemistry AP - Block B", "subject": "chemistry", "grade": 11, "org": "early_college"},
        {"teacher": "early_3", "name": "Biology Honors - Block C", "subject": "biology", "grade": 10, "org": "early_college"},
    ]
...
def seed_class_students(session, class_ids, student_ids):
    ...
    for i, class_id in enumerate(class_ids):
        ...
        end_idx = start_idx + students_per_class if i < len(class_ids) - 1 else len(student_ids)
